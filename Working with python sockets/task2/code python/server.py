...
def server():
    ...
    with open('шлях_файлу_який_приймає_команди_від_клієнтів', 'w') as file:  # очищаєм файл(для запису) в який записуєм всі команди клієнтів
        pass
    ...
    while not quit:  # поки сервер не відключився
        try:
            ...
            with open('/Users/andrejlasuk/Desktop/С++/КМ1/Варік 10/команди відправленні на сервер .txt', 'a+', encoding='utf-8') as file:  #  відкриваєм файл для запису
